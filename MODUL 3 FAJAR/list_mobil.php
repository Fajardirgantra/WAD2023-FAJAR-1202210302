...
<body>
    ...
    <center>
        <div class="container">
            ...
            echo "<tr>";
            echo "<th>" . $selects['id'] . "</th>";
            echo" <td>" . $selects['nama_mobil'] . "</td>";
            echo" <td>" . $selects['brand_mobil']. "</td>";
            echo" <td>" . $selects['warna_mobil']. "</td>";
            echo" <td>" . $selects['tipe_mobil']. "</td>";
            echo" <td> ". $selects['harga_mobil']. "</td>";
            echo"</tr>";
